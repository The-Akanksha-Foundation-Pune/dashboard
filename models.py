...
class StudentAssessmentData(db.Model):
    ...
    grade_name = db.Column(db.String(10), nullable=True)
    assessment_id = db.Column(db.String(50), nullable=True)
    student_id = db.Column(db.String(100), nullable=True)
    course_name = db.Column(db.String(50), nullable=True)
    competency_level_name = db.Column(db.String(255), nullable=True)
    division_name = db.Column(db.String(10), nullable=True)
    assessmentDate = db.Column(db.Date, nullable=True)
    ...
    student_assessment_id_unique_key = db.Column(db.String(500), nullable=True)
    update_time = db.Column(db.String(100), nullable=True)

    def __repr__(self):
        return f'<StudentAssessmentData {self.student_id} - {self.assessment_id}>'
